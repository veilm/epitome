...
| Yudkowsky fiction and writing | **Pilot active; explicitly low risk.** The rendered public inventory found the Sword of Good page, a writing index, and 13 canonical linked writing pages; a seven-route varied pilot is prepared and the remaining eight routes are ready as N+1. | Complete and audit `data/yudkowsky-fiction-writing-pilot.txt`, then start `data/yudkowsky-fiction-writing-next-8.txt` while preserving the public-only boundary. |
