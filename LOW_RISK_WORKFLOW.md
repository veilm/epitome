...
| Astral Codex Ten | **Six bounded production batches complete: 315 pages, plus a five-page pilot.** The reviewed first-party archive contains 1,452 canonical posts: 1,170 public and 282 paid-only preview identities. The batches preserve long articles, images, comments, media references, and the paid-preview boundary. The sixth batch has 90/90 complete and tab-closed pages with zero page failures; its 31 dependency-asset failures and 32 response-body errors were classified, both image audits were clean, and representative paid-preview, ordinary, links-heavy, comment-heavy, and Mux/media-reference replays made no production-origin requests. Exact YouTube/Twitter/X asset exclusions recorded 14 skipped decisions and no excluded-host asset result; three incidental YouTube-nocookie page dependencies were retained as network-only source references, with no downloader invoked. | Start the prepared 105-page list at `data/astral-codex-ten-next-105.txt` with the port-2103-only workflow, the access boundary, bounded asset policy, and exact YouTube/Twitter/X host exclusions; audit before growing again. |
