...
| Astral Codex Ten | **Pilot approved; 5 representative pages captured.** The reviewed first-party archive contains 1,452 canonical posts: 1,170 public and 282 paid-only preview identities. Offline replay preserved long articles, images, and large comment threads without production requests. | Capture the prepared first 15 uncaptured posts, including paid-preview boundary checks, then grow only after batch audit. |
