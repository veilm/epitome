...
| Paul Graham essays | **Baseline complete: 232/232.** The approved index-and-essay scope is captured and offline-verified; one newly listed public refresh identity remains in the current plan. | After AI-2040, capture the prepared one-route Paul Graham refresh, then reconcile the refresh plan. |
