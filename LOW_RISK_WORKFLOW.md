...
| Slate Star Codex | **Partial.** The 1,562-identity canonical scope and five representative variants are approved; no large page batch has begun. | Source list is ready at `sources/slate-star-codex.txt`. Prepare the first bounded deduplicated batch command before it reaches N. |
