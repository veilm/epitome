...
| Greg Brockman blog | **Approved low-risk source; pilot ready.** The rendered home and `/page/2` listings expose 17 canonical posts plus home/feed/page-2 structural routes, for a reviewed 20-route scope. | Run the bounded public pilot, then capture the full deduplicated 20-route scope; the X link remains a reference only. |
