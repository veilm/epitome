...
| Astral Codex Ten | **Nine bounded production batches complete: 675 pages, plus a five-page pilot.** The reviewed first-party archive contains 1,452 canonical posts: 1,170 public and 282 paid-only preview identities. The batches preserve long articles, images, comments, media references, and the paid-preview boundary. The ninth batch has 135/135 complete and tab-closed pages with zero page failures; its 284 asset-completion failures and 285 response-body errors were classified, both image audits were clean, and representative paid-preview, ordinary, links-heavy, comment-heavy, and YouTube-reference replays made no production-origin requests. Exact YouTube/Twitter/X asset exclusions recorded 10 decisions and no excluded-host asset result; no YouTube or Twitter/X downloader was invoked. | Start the prepared 150-page list at `data/astral-codex-ten-next-150.txt` with the port-2103-only workflow, the access boundary, bounded asset policy, and exact YouTube/Twitter/X host exclusions; audit before growing again. |
