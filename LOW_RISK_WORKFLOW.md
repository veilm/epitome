...
| Gwern.net | **Validated and N+1-ready; explicitly low risk.** The public essays index, blog/document indexes, long essay, fiction, and recent blog are substantive static pages; known missing images and the direct-video `/embryo-selection` route are bounded risks kept out of the ordinary lane. | Capture and audit the prepared seven-route public-only `data/gwern-pilot.txt` before expanding the family inventories. |
