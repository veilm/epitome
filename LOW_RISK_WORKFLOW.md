...
| Astral Codex Ten | **Ten bounded production batches complete: 825 pages, plus a five-page pilot.** The reviewed first-party archive contains 1,452 canonical posts: 1,170 public and 282 paid-only preview identities. The batches preserve long articles, images, comments, media references, and the paid-preview boundary. The tenth batch has 150/150 complete and tab-closed pages with zero page failures; its 77 asset-completion failures and 86 response-body errors were classified, including five unavailable primary images and two excluded Twitter-host avatar variants. The primary/all-image audits and bounded paid-preview, ordinary, links-heavy, comment-heavy, media-reference, middle, and late replays were completed; 890 replay requests stayed on `127.0.0.1:8023` with no production-origin requests. Exact YouTube/Twitter/X asset exclusions recorded 11 decisions with no excluded-host asset result; no YouTube or Twitter/X downloader was invoked. | Start the prepared 165-page list at `data/astral-codex-ten-next-165.txt` with the port-2103-only workflow, the access boundary, bounded asset policy, and exact YouTube/Twitter/X host exclusions; audit before growing again. |
