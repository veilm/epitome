...
| Claude blog and research | **N+1 ready: 37-route public refresh delta; explicitly low risk.** The prior 29/29 public refresh is complete, and the new plan-only snapshot produced 37 genuinely new canonical public posts; the known 41 historical uncaptured identities remain outside the ordinary refresh. | Prepared list `/mnt2/capsule/epitome/refresh/1789621253/claude.txt`; start it after OpenAI’s 18-route N batch passes its audits. |
