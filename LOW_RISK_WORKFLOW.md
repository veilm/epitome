...
| Astral Codex Ten | **Four bounded production batches complete: 150 pages, plus a five-page pilot.** The reviewed first-party archive contains 1,452 canonical posts: 1,170 public and 282 paid-only preview identities. The batches preserve long articles, images, comments, media-bearing content, and the paid-preview boundary. The fourth batch has 60/60 complete and tab-closed pages with zero page failures; its 17 dependency-asset failures and 19 response-body errors were classified, the one all-image omission was repaired, and representative paid-preview, YouTube-embed, comment-heavy, and Mux replays made no production-origin requests. Exact YouTube/Twitter/X host exclusions recorded seven skipped decisions and no excluded-host asset or network downloads. | Start the prepared 75-page list at `data/astral-codex-ten-next-75.txt` with the port-2103-only workflow, the access boundary, bounded asset policy, and exact YouTube/Twitter/X host exclusions; audit before growing again. |
