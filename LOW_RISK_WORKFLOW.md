...
| alien.v01d.zone | **Validated and active; explicitly low risk.** The canonical public material is a single long-form page with approximately 220,166 visible characters, 15 images, no iframe/video/audio, and fragment-only same-origin navigation. | Complete and audit the prepared one-route `data/alien-v01d-pilot.txt`, preserving the static/image, telemetry, and long-form replay checks. |
