...
| Astral Codex Ten | **Two bounded batches complete: 45 pages.** The reviewed first-party archive contains 1,452 canonical posts: 1,170 public and 282 paid-only preview identities. The batches preserve long articles, images, comments, media-bearing content, and the paid-preview boundary. The second batch has 30/30 complete and tab-closed pages, 13 classified dependency-asset failures, and 17 response-body errors that did not affect page capture; primary/all-image audits and loopback replay are clean. | Prepare a deduplicated next bounded list before capturing more; retain the port-2103-only workflow, access boundary, and bounded asset policy. |
