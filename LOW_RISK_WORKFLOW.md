...
| Citrini Research article | **Validated and active; explicitly low risk.** Canonical page `https://www.citriniresearch.com/p/2028gic` rendered publicly with a substantive article, 26 images, and no access-control bypass. | Complete and audit `data/citrini-research-pilot.txt`, then prepare the next low-risk source. |
