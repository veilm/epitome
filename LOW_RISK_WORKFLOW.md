...
| Cyborgism Wiki | **Validated and active; explicitly low risk.** The public home and representative `/hypha/cyborgism` page render as stable first-party wiki pages with no frames or account requirement. | Complete and audit `data/cyborgism-wiki-pilot.txt`, then prepare the next low-risk source. |
