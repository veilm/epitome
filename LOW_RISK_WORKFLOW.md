...
| --- | --- | --- |
| LessWrong | **Partial.** Taxonomy and the 1,384-post core/curated inventory are complete. The seven-page pilot, all 51 rendered Highlights identities, all 19 Janus identities, the nine-route priority pilot, and all deduplicated priority sequence members (29 Fun Theory, 12 6BF, and 16 Highly Advanced Epistemology) pass capture/image checks; 13 rendered-only historical/external image gaps are classified and the priority queue is complete. | Prepare and capture a varied public Yudkowsky fiction/writing pilot while preserving LessWrong mirror deduplication and the public-only boundary. |
