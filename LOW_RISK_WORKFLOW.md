...
| Michael Burry article | **Validated; one-page pilot active; explicitly low risk.** Canonical page `https://post.substack.com/p/the-ai-revolution-is-here-will-the` rendered publicly with a substantive article, 35 images, and no access-control bypass. | Complete and audit the prepared one-page pilot, then advance to the prepared Citrini Research pilot. |
| Citrini Research article | **Validated and N+1-ready; explicitly low risk.** Canonical page `https://www.citriniresearch.com/p/2028gic` rendered publicly with a substantive article, 26 images, and no access-control bypass. | Start `data/citrini-research-pilot.txt` after the Michael Burry boundary, using the same bounded public capture and exact host exclusions. |
