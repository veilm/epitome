...
| OpenAI careers and jobs | **Active N: 18-route public refresh in progress; explicitly low risk.** The prior 78/78 public batches/routes remain complete and the new plan-only snapshot produced 18 genuinely new `/index/` identities. | Active root `/mnt2/capsule/epitome/openai/refresh/1789621253`; after its boundary validation, start the prepared 37-route Claude list at `/mnt2/capsule/epitome/refresh/1789621253/claude.txt`. |
