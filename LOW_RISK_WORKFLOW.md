...
| George Hotz blog | **Approved low-risk source; pilot ready.** The rendered homepage exposes 143 canonical Jekyll posts plus home/about/feed structural routes, for a reviewed 146-route scope. | Run the bounded structural/newest-middle-oldest pilot, then capture the full deduplicated 146-route public list; social links remain references only. |
