...
| Slate Star Codex | **Active.** The 1,562-identity canonical scope, five representative variants, and first 15 uncaptured identities are approved. The next 30 identities are capturing. | Prepare the following 45-page deduplicated list while this batch runs. Retain max 500 assets and use targeted all-image repair at the boundary for late Gravatars. |
